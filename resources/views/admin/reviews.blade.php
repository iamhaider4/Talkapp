    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Talk Proposal</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach($reviews as $review)
                    <tr>
                        <td class="px-6 py-4">
                            <div class="text-sm font-medium text-gray-900">{{ $review->talkProposal->title }}</div>
                            <div class="text-sm text-gray-500">by {{ $review->talkProposal->user->name }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">{{ Str::limit($review->comments, 100) }}</div>
                        </td>
